...
namespace SwiftResume.DAL.EFCORE.Migrations
{
    ...
    [Migration("20211227025649_EducacionExperienciaAdded")]
    partial class EducacionExperienciaAdded
    {
            ...
            modelBuilder.Entity("SwiftResume.COMMON.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateJoined = new DateTime(2021, 12, 26, 21, 56, 48, 961, DateTimeKind.Local).AddTicks(9514),
