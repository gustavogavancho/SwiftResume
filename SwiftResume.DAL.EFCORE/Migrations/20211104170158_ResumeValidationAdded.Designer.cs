...
namespace SwiftResume.DAL.EFCORE.Migrations
{
    ...
    [Migration("20211104170158_ResumeValidationAdded")]
    partial class ResumeValidationAdded
    {
            ...
            modelBuilder.Entity("SwiftResume.COMMON.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateJoined = new DateTime(2021, 11, 4, 12, 1, 54, 941, DateTimeKind.Local).AddTicks(8046),
