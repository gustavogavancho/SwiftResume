...
namespace SwiftResume.DAL.EFCORE.Migrations
{
    ...
    [Migration("20211227174848_TipoEducacionColumnAdded")]
    partial class TipoEducacionColumnAdded
    {
            ...
            modelBuilder.Entity("SwiftResume.COMMON.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateJoined = new DateTime(2021, 12, 27, 12, 48, 48, 244, DateTimeKind.Local).AddTicks(8928),
