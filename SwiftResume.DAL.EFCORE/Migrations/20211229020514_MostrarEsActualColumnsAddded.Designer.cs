...
namespace SwiftResume.DAL.EFCORE.Migrations
{
    ...
    [Migration("20211229020514_MostrarEsActualColumnsAddded")]
    partial class MostrarEsActualColumnsAddded
    {
            ...
            modelBuilder.Entity("SwiftResume.COMMON.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateJoined = new DateTime(2021, 12, 28, 21, 5, 13, 850, DateTimeKind.Local).AddTicks(9216),
