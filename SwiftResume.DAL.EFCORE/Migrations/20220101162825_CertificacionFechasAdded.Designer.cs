...
namespace SwiftResume.DAL.EFCORE.Migrations
{
    ...
    [Migration("20220101162825_CertificacionFechasAdded")]
    partial class CertificacionFechasAdded
    {
            ...
            modelBuilder.Entity("SwiftResume.COMMON.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateJoined = new DateTime(2022, 1, 1, 11, 28, 25, 139, DateTimeKind.Local).AddTicks(5237),
