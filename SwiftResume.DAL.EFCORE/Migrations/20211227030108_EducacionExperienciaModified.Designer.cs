...
namespace SwiftResume.DAL.EFCORE.Migrations
{
    ...
    [Migration("20211227030108_EducacionExperienciaModified")]
    partial class EducacionExperienciaModified
    {
            ...
            modelBuilder.Entity("SwiftResume.COMMON.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateJoined = new DateTime(2021, 12, 26, 22, 1, 7, 850, DateTimeKind.Local).AddTicks(2406),
